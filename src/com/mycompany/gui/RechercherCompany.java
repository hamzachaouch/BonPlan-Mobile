 ...
 * @author HP
 */
public class RechercherCompany {
...
//    EncodedImage placeholder = EncodedImage.createFromImage(p.scaled(p.getWidth() * 4, p.getHeight() * 5), false);
    ...
    public RechercherCompany() throws IOException {
        ...
        for (Company company : companies) {
            mb = new MultiButton();
            mb.setTextLine1(company.getName());
            mb.setTextLine2(company.getDescription());
            mb.setTextLine3(company.getAddress());
